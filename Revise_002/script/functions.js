    ...
    var interval = setInterval(function() {
        ...
        if(seconds == 0) {
            if(minute_text == '' && hour_text == '') {
                ...
                if(['countdown4', 'countdown5', 'countdown6'].includes(element)){
                ...
                let priority1 = ['countdown1', 'countdown2', 'countdown3', 'countdown4', 'countdown5',
                                 'countdown6', 'countdown29', 'countdown30', 'countdown31'];
                                 
                let priority2 = [7, 8, 9, 10, 11, 12, 13, 14];
                let priority3 = [15, 16, 17];
